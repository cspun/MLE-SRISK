...
#           're_excess_2','equ_vol_2','Rsysh','Varh']].iloc[xydata.shape[0]-1:xydata.shape[0],:]
    xdata_predict = xydata[['VOL', 'RET', 'X3T_change', 'change_slope', 'ted', 'cre_spread',
           're_excess','equ_vol', 'VOL_2','RET_2','X3T_change_2','change_slope_2','ted_2','cre_spread_2','sp500',
           're_excess_2','equ_vol_2','size','maturity_mismatch','leverage','boom','size_2',
           'maturity_mismatch_2','leverage_2','boom_2','Rsysh','Varh']].iloc[xydata.shape[0]-1:xydata.shape[0],:]
    ...
    keep_prob=0.5
    num_layers_0=30
    X = tf.placeholder(tf.float32, [None, xdata.shape[1]])
    y = tf.placeholder(tf.float32, [None,1])
    ...
    # LSTM
    weights_1_1 = tf.Variable(tf.random_normal([xdata.shape[1],num_layers_0], stddev=(1/tf.sqrt(float(xdata.shape[1])))))
    bias_1_1 = tf.Variable(tf.random_normal([num_layers_0], stddev=(1/tf.sqrt(float(xdata.shape[1])))))
